...
Cancellation is a business operation, not a status mutation. Before payment it may cancel a draft or pending payment. After payment, cancellation requires policy checks and may be refused once a label is created or fulfillment has started.
